...
public class PostWithAuthCache extends Request {

	static final Logger logger = Logger.getLogger(PostWithAuthCache.class);
	Integer TestNumber = null;

	public PostWithAuthCache(TestCase test) throws Exception {
		super(test);
	}

	public PostWithAuthCache() {
		super();
	}
	...
	public void sendRequest() throws Exception {
		...
		try {
			...
			logger.info("POST Request: " + url.toString());
