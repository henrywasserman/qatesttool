...
<xsl:output method="xml"/>
	...
	<xsl:template match="root/principal">
  		<xsl:copy>
    		<xsl:apply-templates>
	    		<xsl:sort select="name()" data-type="text" />
    		</xsl:apply-templates>
	...
	<xsl:template match="root/principal/person">
  		<xsl:copy>
    		<xsl:apply-templates>
	    		<xsl:sort select="name()" data-type="text" />
    		</xsl:apply-templates>
	...
	<xsl:template match="root/principal/person/mailbox">
  		<xsl:copy>
    		<xsl:apply-templates>
	    		<xsl:sort select="name()" data-type="text" />
    		</xsl:apply-templates>
	...
	<xsl:template match="folders">
		<xsl:copy>
			<xsl:apply-templates>
				<xsl:sort select="name" data-type="text" />
				<xsl:sort select="name()" data-tkype="text"/>
			</xsl:apply-templates>
		</xsl:copy>
	</xsl:template>
